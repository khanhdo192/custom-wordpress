$(document).ready(function () {
  ...
  if (window.location.pathname == "/techblog/" || window.location.pathname == "/techblog/en/") {
    loadHomePage();
  }
  ...
  $(".menu-item:has(.trp-ls-language-name)")
    .addClass("menu-translate")
  ...
  $(".formatPrice").each(function () {
    let o = $(this).text();
    (o = o.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ".")), $(this).text(o);
  });
